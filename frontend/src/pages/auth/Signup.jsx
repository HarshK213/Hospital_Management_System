        ...
        <section className="hidden lg:flex lg:w-[45%] clinical-gradient p-8 xl:p-12 flex-col justify-between relative">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-8 xl:mb-12">
              <span className="material-symbols-outlined text-3xl xl:text-4xl text-white">
                clinical_notes
              </span>
              <h1 className="font-bold text-2xl xl:text-3xl tracking-tight text-white">
                Arogya
              </h1>
            </div>
            <div className="space-y-4 xl:space-y-6 max-w-sm">
              ...
              <p className="text-white/90 text-base xl:text-lg leading-relaxed">
                Access your patient records, schedule appointments, and
                communicate with your clinical team in one secure environment.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center gap-3 xl:gap-4 p-3 xl:p-4 rounded-xl glass-panel border border-white/10">
              <div className="w-10 h-10 xl:w-12 xl:h-12 rounded-full overflow-hidden shrink-0 border-2 border-white/50">
                <img
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCCe6soHuxb9T5mYJTU-Un_LPYuYJMbjhlis1_v6Gx_N4GTYK7YPZQzr4n9JCf71ExEV4X2Fbjh4DqdwyoucGFo8cwvsddZ_kUyBMkfDAF5qplKvsD1kkPSh1hzAScPdspHlejKB56tRotiUeNNoOkxQYJCjPb8562QUZWPPf6qGS3aODnpm1-h1-it97mmh0lAkE8fcVY2FxvqKlf83oyglF_btGfqewcEeNBy0hDLugWi7BEH-QzCcb8kVsk8GV5huS4R8R8dcdk"
                  alt="Doctor"
                />
              </div>
              <div>
                <p className="font-bold text-white text-xs xl:text-sm">
                  Clinical Assurance
                </p>
                <p className="text-white/80 text-xs xl:text-sm">
                  "Our precision-first approach ensures your data is handled
          ...
          <div className="absolute bottom-0 right-0 w-full h-1/2 opacity-20 transform translate-y-1/4 translate-x-1/4 pointer-events-none">
            <span className="material-symbols-outlined text-[200px] xl:text-[300px] text-white">
              medical_services
            </span>
          </div>
        </section>
        ...
        <section className="w-full lg:w-[55%] bg-white p-6 sm:p-8 md:p-10 xl:p-12 flex flex-col justify-center">
          <div className="max-w-md w-full mx-auto">
            <div className="flex lg:hidden items-center gap-3 mb-6 sm:mb-8">
              <span className="material-symbols-outlined text-[#007a8a] text-2xl sm:text-3xl">
                clinical_notes
              </span>
              <h1 className="font-bold text-xl sm:text-2xl tracking-tight text-[#007a8a]">
                Arogya
              </h1>
            </div>

            <header className="mb-6 sm:mb-8">
              <h3 className="font-bold text-xl sm:text-2xl xl:text-3xl text-gray-900 mb-2">
                Patient Signup
              </h3>
              <p className="text-gray-600 text-sm sm:text-base">
                Create your clinical profile to begin.
              </p>
            </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              <div>
                ...
                <div className="relative group">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-gray-400 group-focus-within:text-[#007a8a] transition-colors">
                    person
                  </span>
                  <input
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-[10px] xl:text-xs text-gray-400 font-medium">
