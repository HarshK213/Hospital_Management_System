...
const ReceptionistViewPatientDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 p-6">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
        <h2 className="text-2xl font-bold text-primary mb-6">View Patient Details</h2>
...
export default ReceptionistViewPatientDetails;